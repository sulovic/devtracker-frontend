...
const Page404: React.FC = () => {
  return (
    <div
      ...
      style={{ backgroundImage: `url(${background404})` }}
    >
      <div className="text-center">
        <h2 className="bg-slate-100 opacity-90 dark:bg-slate-700">
          404 - UPS, malo smo zalutali...
        </h2>
        <h4 className="bg-slate-100 opacity-90 dark:bg-slate-700">
          Stranica koju ste tažili više ne postoji
        </h4>
        <Link to={"/"}>
